...
export default function FacultyNewRequest() {
  ...
  const computedRows = useMemo(() => {
    return lines.map((l) => {
      ...
      const unitPriceNum = Math.max(0, Number(l.unitPrice || 0));
      return {
        ...l,
        qty,
        unitPriceNum,
        rowTotal: qty * unitPriceNum,
      };
    });
  }, [lines]);
        ...
        <form onSubmit={onCreateDraft} className="space-y-5">
                  ...
                  <tr key={idx} className="border-t border-gray-100 align-top">
                    ...
                    <td className="px-2 py-2">
                      <button
                        ...
                        className="p-1.5 rounded text-red-700 transition-colors duration-150 hover:bg-red-100 hover:text-red-900 disabled:opacity-40 disabled:hover:bg-transparent"
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={addLine}
              className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-300 text-gray-700 transition-all duration-150 hover:bg-gray-100 hover:border-gray-400 hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0"
            >
          ...
          <div className="flex flex-col gap-4 pt-6 mt-6 border-t border-gray-200">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <div className="grid grid-cols-2 gap-3 w-full md:w-auto">
                <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 px-4 py-3 shadow-sm min-w-[160px]">
                  <p className="text-[11px] font-medium uppercase tracking-wide text-gray-500">Requested Quantity</p>
                  <p className="mt-0.5 text-2xl font-bold text-gray-900 tabular-nums leading-tight">{totalQty}</p>
                  <p className="text-[11px] text-gray-500">
                    {lines.filter((l) => l.itemDescription.trim() && Number(l.quantity) > 0).length} line item
                    {lines.filter((l) => l.itemDescription.trim() && Number(l.quantity) > 0).length === 1 ? '' : 's'}
                  </p>
                </div>
                <div className="rounded-xl border border-red-200 bg-gradient-to-br from-red-50 to-white px-4 py-3 shadow-sm min-w-[160px]">
                  <p className="text-[11px] font-medium uppercase tracking-wide text-red-700">Estimated Total</p>
                  <p className="mt-0.5 text-2xl font-bold text-red-900 tabular-nums break-all leading-tight">{money(grandTotal)}</p>
                  {editingDraftId ? (
                    <p className="text-[11px] text-amber-700">Editing existing draft</p>
                  ) : (
                    <p className="text-[11px] text-gray-500">Qty × Unit Price</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 justify-end">
                <button
                  type="submit"
                  disabled={loading}
                  title={currentBudgetValidation || undefined}
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-red-900 text-red-900 bg-white transition-all duration-150 hover:bg-red-50 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none min-w-[200px]"
                >
                ...
                {editingDraftId ? (
                  <button
                    ...
                    disabled={loading}
                    onClick={resetForm}
                    className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-gray-300 text-gray-700 bg-white transition-all duration-150 hover:bg-gray-100 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none min-w-[200px]"
                  >
                    Cancel editing
                  </button>
                ) : null}
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-red-900 text-white transition-all duration-150 hover:bg-red-800 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none min-w-[200px]"
                >
              ...
              <div key={r.id} className="flex items-center justify-between gap-4 p-4 rounded-xl border border-gray-100">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-amber-300 text-amber-800 bg-amber-50 transition-all duration-150 hover:bg-amber-200 hover:border-amber-500 hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-gray-300 text-gray-700 bg-white transition-all duration-150 hover:bg-gray-100 hover:border-gray-400 hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-red-300 text-red-800 bg-red-50 transition-all duration-150 hover:bg-red-200 hover:border-red-500 hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none"
                  >
                    <Trash2 className="w-4 h-4" />
                    Delete
                  </button>
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-gray-900 text-white transition-all duration-150 hover:bg-gray-700 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none"
                  >
                    Submit
                  </button>
                </div>
